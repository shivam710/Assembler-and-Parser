...
{
       0,     3,     5,     4,     6,     8,     7,     9,    11,    10,
      12,    14,    13,    15,    17,    16,    18,    20,    19,    21,
      23,    22,    24,    26,    25,    27,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
{
       0,    66,    66,    67,    66,    72,    76,    77,    81,   111,
     112,   115,   124,   136,   137,   141,   142,   143,   144,   148,
     172,   173,   185,   200,   201,   213,   228,   246,   247,   248,
     252,   256,   260,   264,   268,   269,   273
};
#endif
...
{
  "$end", "error", "$undefined", "MYTOKEN_PROGRAM", "MYTOKEN_BEGIN",
  "MYTOKEN_VAR", "MYTOKEN_END", "MYTOKEN_INT_TYPE", "MYTOKEN_END_DOT",
  "MYTOKEN_REAL_TYPE", "MYTOKEN_READ", "MYTOKEN_FOR", "MYTOKEN_WRITE",
  "MYTOKEN_DO", "MYTOKEN_TO", "MYTOKEN_SEMICOLON", "MYTOKEN_COMMA",
  "MYTOKEN_COLON", "MYTOKEN_ASSIGN", "MYTOKEN_MINUS", "MYTOKEN_PLUS",
  "MYTOKEN_MULT", "MYTOKEN_OPEN_BRACKET", "MYTOKEN_DIV",
  "MYTOKEN_CLOSE_BRACKET", "MYTOKEN_INT", "MYTOKEN_ID", "MYTOKEN_REAL",
  "$accept", "prog", "$@1", "$@2", "prog_name", "dec_list", "dec", "type",
  "id_list", "stmt_list", "stmt", "assign", "exp", "term", "factor",
  "read", "write", "for", "index_exp", "body", "ID", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,     1,     3,     2,     4,     6,     5,     7,
       9,     8,    10,    12,    11,    13,    15,    14,    16,    18,
...
{
      12,     4,    40,   -40,    44,   -40,   -40,   -40,     4,   -40,
       4,    39,   -40,    49,   -40,     4,    41,     7,   -40,   -40,
     -40,   -40,    42,     4,    43,    -7,   -40,   -40,   -40,   -40,
     -40,     5,     4,    48,    50,     4,   -40,     7,    19,    -3,
       0,    19,    11,   -40,    19,   -40,   -40,    38,    31,   -40,
     -40,   -40,     7,   -40,   -40,    18,   -40,    23,    19,    19,
      19,    19,    14,    19,   -40,    31,    31,   -40,   -40,   -40,
      38
};
...
static const yytype_int8 yydefact[] =
{
       ...
       7,     0,    11,     0,     6,     0,     0,     0,    12,     9,
      10,     8,     0,     0,     0,     0,    13,    15,    16,    17,
      18,     0,     0,     0,     0,     0,     4,     0,     0,     0,
       0,     0,     0,    14,     0,    27,    28,    19,    20,    23,
      26,    30,     0,    34,    32,     0,    31,     0,     0,     0,
       0,     0,     0,     0,    29,    22,    21,    24,    25,    35,
      33
};
...
{
     -40,   -40,   -40,   -40,   -40,    56,   -40,   -40,   -29,    15,
     -12,   -40,   -39,     1,     2,   -40,   -40,   -40,   -40,   -40,
      -1
};
...
{
      -1,     2,     8,    13,     4,     9,    10,    21,    11,    25,
      26,    27,    47,    48,    49,    28,    29,    30,    33,    54,
      50
};
...
{
       5,    36,    55,    39,    52,    57,    42,    12,    37,    12,
      22,    23,    24,    15,    18,     1,    31,    22,    23,    24,
      69,    51,    34,    38,    70,    43,     3,    15,    53,    37,
       3,    12,    63,     3,    12,    56,    31,    58,    59,    31,
       6,    44,    58,    59,    45,     3,    46,    64,    19,     7,
      20,    31,    60,    17,    61,    15,    16,    58,    59,    65,
      66,    40,    67,    68,    32,    35,    14,    62,    41
};

static const yytype_int8 yycheck[] =
{
       1,     8,    41,    32,     4,    44,    35,     8,    15,    10,
      10,    11,    12,    16,    15,     3,    17,    10,    11,    12,
       6,    24,    23,    18,    63,    37,    26,    16,    40,    15,
      26,    32,    14,    26,    35,    24,    37,    19,    20,    40,
       0,    22,    19,    20,    25,    26,    27,    24,     7,     5,
       9,    52,    21,     4,    23,    16,    17,    19,    20,    58,
      59,    13,    60,    61,    22,    22,    10,    52,    18
};
...
{
       0,     3,    29,    26,    32,    48,     0,     5,    30,    33,
      34,    36,    48,    31,    33,    16,    17,     4,    48,     7,
       9,    35,    10,    11,    12,    37,    38,    39,    43,    44,
      45,    48,    22,    46,    48,    22,     8,    15,    18,    36,
      13,    18,    36,    38,    22,    25,    27,    40,    41,    42,
      48,    24,     4,    38,    47,    40,    24,    40,    19,    20,
      21,    23,    37,    14,    24,    41,    41,    42,    42,     6,
      40
};
...
yyreduce:
  ...
  case 2:
#line 66 "yacc.y"
                                                                      {varable_activeFlag =1;gCount++;}
#line 1400 "yacc.tab.c"
    break;

  case 3:
#line 67 "yacc.y"
                                                 {varable_activeFlag =0;gCount++;}
...
#line 82 "yacc.y"
						...
						{ 
							...
							{ 
								...
								tempVar.symbol_type = (yyvsp[0].integer_val);progC++;gCount++; 							// set symbol_type, MYTOKEN_INT_TYPE or MYTOKEN_REAL_TYPE
...
#line 1461 "yacc.tab.c"
  ...
  case 9:
#line 111 "yacc.y"
                                                                                {(yyval.integer_val) = MYTOKEN_INT_TYPE;gCount++;progC++;}
#line 1467 "yacc.tab.c"
    break;

  case 10:
#line 112 "yacc.y"
                                                                                        {(yyval.integer_val) = MYTOKEN_REAL_TYPE;progC++;gCount++;}
...
#line 116 "yacc.y"
						...
						{ 
							string temp((yyvsp[0].string_val));gCount++;
...
#line 149 "yacc.y"
                                        {
						progC++;
						string temp((yyvsp[-2].string_val));gCount++;
						...
						{ 
							...
							sprintf(errorString,"Error at line %d, %s variable is not declared in the scope",line_no_count,(yyvsp[-2].string_val));gCount++;
							addErrorMessage(errorString);gCount++;
						}
						else if(itr->second.symbol_type != (yyvsp[0].integer_val))
						{
							progC++;
							// If symbol_type is not matched between ariable and the expression
							handleTypeMismatch(itr->second.symbol_type,(yyvsp[0].integer_val));gCount++; 		// handle the symbol_type error using handleTypeMismatch function
						}
...
#line 1560 "yacc.tab.c"
  ...
  case 20:
#line 172 "yacc.y"
                                     {(yyval.integer_val) = (yyvsp[0].integer_val);gCount++;progC++;}
...
#line 174 "yacc.y"
                                        {
						gCount++;
						if((yyvsp[-2].integer_val) == (yyvsp[0].integer_val))	// If same type
						{ 
							(yyval.integer_val) = (yyvsp[-2].integer_val);progC++;
						}
						else			// otherwise handle different types
						{ 
							handleTypeMismatch((yyvsp[-2].integer_val),(yyvsp[0].integer_val));progC++;
						}
					}
...
#line 186 "yacc.y"
                                        {
						gCount++;
						if((yyvsp[-2].integer_val) == (yyvsp[0].integer_val))
						{
							(yyval.integer_val) = (yyvsp[-2].integer_val);progC++;
						}
						else
...
#line 1598 "yacc.tab.c"
  ...
  case 23:
#line 200 "yacc.y"
                                       {(yyval.integer_val) = (yyvsp[0].integer_val);progC++;gCount++;}
...
#line 229 "yacc.y"
						...
						{ 	
							progC++;		
							errorString[0]='\0';gCount++;
							sprintf(errorString,"Error at line %d, %s variable is not declared in the scope",line_no_count,(yyvsp[0].string_val));gCount++;
							addErrorMessage(errorString);gCount++;
						}
						else
						{
							progC++;
							(yyval.integer_val) = itr->second.symbol_type; gCount++;		// If found then return the symbol_type of the variable
						}
					}
...
#line 1670 "yacc.tab.c"
  ...
  case 29:
#line 248 "yacc.y"
                                                                                       {(yyval.integer_val) = (yyvsp[-1].integer_val);gCount++;progC++;}
...
#line 274 "yacc.y"
						...
						(yyval.string_val) = yylval.string_val;gCount++;progC++; 						// otherwise return the variable name
				  	}
